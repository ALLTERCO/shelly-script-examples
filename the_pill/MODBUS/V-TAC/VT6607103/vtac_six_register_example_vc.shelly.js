...
var ENTITIES = [
  { key: 'pv1Voltage', name: 'PV1 Voltage', addr: 5776, scale: 0.1, unit: 'V', vcHandle: null },
  { key: 'pv2Voltage', name: 'PV2 Voltage', addr: 5778, scale: 0.1, unit: 'V', vcHandle: null },
  { key: 'inputVoltage', name: 'Input Voltage', addr: 5784, scale: 0.1, unit: 'V', vcHandle: null },
  { key: 'outputVoltage', name: 'Output Voltage', addr: 5786, scale: 0.1, unit: 'V', vcHandle: null },
  { key: 'power', name: 'Power', addr: 5790, scale: 0.01, unit: 'W', vcHandle: null },
  { key: 'frequency', name: 'Frequency', addr: 5792, scale: 0.01, unit: 'Hz', vcHandle: null }
];
  ...
  components: [
    {
      ...
      config: {
        ...
        persisted: true,
        default_value: 0,
        meta: { ui: { view: 'progressbar', unit: 'V', icon: ICONS.pv1, step: 1 } }
      }
    },
    {
      key: 'pv2Voltage',
    ...
    },
    {
      ...
      config: {
        ...
        persisted: false,
        default_value: 0,
        meta: { ui: { view: 'progressbar', unit: 'V', icon: ICONS.inputVoltage, step: 1 } }
      }
    },
    {
      key: 'outputVoltage',
      ...
      config: {
        ...
        persisted: false,
        default_value: 0,
        meta: { ui: { view: 'progressbar', unit: 'V', icon: ICONS.outputVoltage, step: 1 } }
      }
    },
    {
      key: 'power',
      ...
      config: {
        ...
        persisted: false,
        default_value: 0,
        meta: { ui: { view: 'progressbar', unit: 'W', icon: ICONS.power, step: 1 } }
      }
    },
    {
      key: 'frequency',
...
function bindVcHandles(readyVc) {
  ...
  for (i = 0; i < ENTITIES.length; i++) {
    ENTITIES[i].vcHandle = readyVc.handles[ENTITIES[i].key];
  }
}
