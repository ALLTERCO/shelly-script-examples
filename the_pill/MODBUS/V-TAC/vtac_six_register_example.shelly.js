...
var ENTITIES = [
  { name: 'PV1 Voltage', addr: 5776, scale: 0.1, unit: 'V' },
  { name: 'PV2 Voltage', addr: 5778, scale: 0.1, unit: 'V' },
  { name: 'Input Voltage', addr: 5784, scale: 0.1, unit: 'V' },
  { name: 'Output Voltage', addr: 5786, scale: 0.1, unit: 'V' },
  { name: 'Power', addr: 5790, scale: 0.01, unit: 'W' },
  { name: 'Frequency', addr: 5792, scale: 0.01, unit: 'Hz' },
];
...
function pollEntities() {
  ...
  function readNext(index) {
    if (index >= ENTITIES.length) {
      var i;
      print('--- V-TAC six-register example ---');
...
function init() {
  print('V-TAC VT-66036103 six-register example');
  print('=======================================');
