/**
 * @title iRobot Roomba Open Interface library + Virtual Components
 * @description UART library implementing the iRobot Open Interface (OI) for Roomba
 *   500 series control with self-created Shelly Virtual Components.
 * @status under development
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/the_pill/iRobotRoomba/roomba_vc.shelly.js
 */
...
var VIRTUAL_COMPONENTS = {
    ...
    groups: [
        { id: 200, name: "Roomba Status", components: ["statusDisplay", "batteryDisplay"] }
    ]
};
