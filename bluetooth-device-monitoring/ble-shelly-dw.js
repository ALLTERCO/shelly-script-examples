...
// CHANGE HERE
function windowOpenAction() {
  print("Window is opened");
  print(CONFIG.BTH_packet);
//  BTH packet: {"rssi":-67,"addr":"60:ef:ab:40:a8:af","Rotation":52.900000,"Window":1,"Illuminance":179,"Battery":100,"pid":136,"BTHome_version":2,"encryption":false}
}

function windowClosedAction() {
  print("Window is closed");
  print(CONFIG.BTH_packet);
//  BTH packet: {"rssi":-67,"addr":"60:ef:ab:40:a8:af","Rotation":0,"Window":0,"Illuminance":179,"Battery":100,"pid":136,"BTHome_version":2,"encryption":false}    
}
...
//    console.log("Shelly BTH packet: ", JSON.stringify(BTHparsed));
  CONFIG.BTH_packet = JSON.stringify(BTHparsed);
