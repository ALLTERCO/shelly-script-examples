// Blu Button channels across multiple Pro 4PM's with some Button Press combinations 
...
let TARGET_IP = '192.168.0.15';
  ...
  function buttonActionOn(CHANNEL_ID) {
  ...
  function buttonActionOff(CHANNEL_ID) {
    ...
    actions: [
        {
            ...
            action: buttonActionOn(1), // 1 short press
            action: buttonActionOn(2), // 1 short press
            action: buttonActionOn(3), // 1 short press
            action: buttonActionOn(4), // 1 short press

            // action: buttonActionOff(1), // 1 short press
            // action: buttonActionOff(2), // 1 short press
            // action: buttonActionOff(3), // 1 short press
            // action: buttonActionOff(4), // 1 short press
