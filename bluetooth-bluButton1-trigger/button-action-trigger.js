...
let TARGET_PORT = '';
  ...
  function buttonAction(BTHparsed) {
    // print(BTHparsed.Button === 4 ? 'Long Press' : JSON.stringify(BTHparsed.Button) + 'Short press');
    ...
    Shelly.call(
        ...
        { 
            ...
            body: {
                ...
                "State":BTHparsed.Button === 4 ? 'Long Press' : JSON.stringify(BTHparsed.Button) + ' Short press',
            },
        },
