...
the_pill/_backup/_backup_uart.shelly.js: Backup: early YS-IRTM UART script (deprecated)
===
Deprecated backup script with basic YS-IRTM UART handling and known issues.

the_pill/_backup/_backup_tvt.shelly.js: Backup: corrupted TV IR script (deprecated)
===
Backup script preserved for reference; not intended for use.
