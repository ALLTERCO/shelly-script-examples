...
let TARGET_PORT = '3456';

function windowAction(BTHparsed) {
    // print("Window is", BTHparsed.Window === 1 ? 'open' : 'closed');
    let TARGET_URI = "http://" + TARGET_IP + ":" + TARGET_PORT + '/DWBLU/' + BTHparsed.addr;
    print(TARGET_URI);
    Shelly.call(
        "HTTP.REQUEST", 
        { 
            ...
            url: TARGET_URI,
            body: {
                "DeviceId":BTHparsed.addr,
                "DeviceType":"DoorWindow",
                "Lux":BTHparsed.Illuminance,
                "Rotation":BTHparsed.Rotation,
                "Battery":BTHparsed.Battery,
                "State":BTHparsed.Window === 1 ? 'open' : 'closed'
            },
        },
